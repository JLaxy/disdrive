...
def create_train_test_split(dataset, test_size=0.2, random_state=42):
    ...
    for class_idx in range(len(train_dist)):
        ...
        print(f"{class_idx}\t{train_dist[class_idx]}\t{test_dist[class_idx]}\t{train_percent:.1f}%\t{test_percent:.1f}%")
...
if __name__ == "__main__":
    ...
    train_dataset, test_dataset = create_train_test_split(dataset, test_size=0.2, random_state=42)
