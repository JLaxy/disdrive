...
_FOLDER_SORT_PATH = "F:\\Jownjown\\Education\\4th Year\\1st Sem\\Thesis 1\\Datasets\\Singapore AutoMan Distracted Driving\\SAM-DD(RGB)\\Evaluation\\Front View"
    ...
    for behavior, behavior_code in _BEHAVIORS.items():  # For each behavior
        ...
        for tester in os.listdir(_TESTERS_PATH):  # For each tester
            ...
            folder_behavior = os.path.join(
                _TESTERS_PATH, tester, behavior_code, "front_RGB")
            ...
            for frame in frames:
                ...
                dest_path = os.path.join(
                    _FOLDER_SORT_PATH, behavior, f"FRONT_{behavior.replace(' ', '_')}_{count:05d}.jpg")
